...
#'     length 1.
#' @param enforce_ascii_msg If \code{TRUE}, the logging message is guaranteed to
...
#' @param enforce_tz_utc If \code{TRUE}, the logging time field is converted to
...
#' @param log_to_azure If \code{TRUE} then logs will be sent to Azure log
...
#'
#' @param key Specify the key whose value needs to be extracted.
#'
#' @return Returns the respective config value of the given key.
#' @export
#' @family Logging configurations
#' @rdname configuration
