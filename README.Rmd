...
Please refer the vignette article `vignette("how-to-use-azlogr")` to know more on how to configure Azure Log Analytics workspace credentials and use this package.
